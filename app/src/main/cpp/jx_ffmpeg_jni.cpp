...
Java_com_fuj_enjoytv_camera_FFmpegBridge_prepareJXFFmpegEncoder(JNIEnv *env, jclass type,
    jstring media_base_path_, jstring media_name_, jint v_custom_format, jint in_width, jint in_height,
    jint out_width, jint out_height, jint frame_rate, jlong video_bit_rate) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_fuj_enjoytv_camera_FFmpegBridge_encodeFrame2H264(JNIEnv *env, jclass type, jbyteArray data_) {
...
Java_com_fuj_enjoytv_camera_FFmpegBridge_getFFmpegConfig(JNIEnv *env, jclass type) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_fuj_enjoytv_camera_FFmpegBridge_encodeFrame2AAC(JNIEnv *env, jclass type, jbyteArray data_) {
    jbyte *elements = env->GetByteArrayElements(data_, 0);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_fuj_enjoytv_camera_FFmpegBridge_recordEnd(JNIEnv *env, jclass type) {
...
Java_com_fuj_enjoytv_camera_FFmpegBridge_nativeRelease(JNIEnv *env, jclass type) {
    if (aac_encoder != NULL) {
        try {
            aac_encoder->release();
        } catch (exception e) {}
