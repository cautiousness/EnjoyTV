...
public class FFmpegBridge {
    ...
    public static final int ALL_RECORD_END = 1; // 结束录制并且转码保存完成
    public final static int ROTATE_0_CROP_LF = 0;
    public final static int ROTATE_90_CROP_LT = 1; // 旋转90度剪裁左上
    public final static int ROTATE_180 = 2; // 暂时没处理
    public final static int ROTATE_270_CROP_LT_MIRROR_LR = 3; // 旋转270(-90)裁剪左上，左右镜像
     ...
     * @return 返回0表示成功
     */
    private static native int runCMD(String cmd[]);
