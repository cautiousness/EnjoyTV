...
public class MediaRecorderNative extends MediaRecorderBase implements MediaRecorder.OnErrorListener,
    ...
    public MediaObject.MediaPart startRecord() {
        ...
        FFmpegBridge.prepareJXFFmpegEncoder(mMediaObject.getOutputDirectory(),
            mMediaObject.getBaseName(), vCustomFormat, mSupportedPreviewWidth, SMALL_VIDEO_HEIGHT,
            SMALL_VIDEO_WIDTH, SMALL_VIDEO_HEIGHT, mFrameRate, mVideoBitrate);
        ...
        if (mMediaObject != null) {
            ...
            if (mAudioRecorder == null) { //如果需要定制非480x480的视频，可以启用以下代码，其他vf参数参考ffmpeg的文档：
