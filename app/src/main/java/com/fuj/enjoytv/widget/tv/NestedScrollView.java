...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent,
    ...
    int lastY;
    private OnFlingOverflowListener flingOverflowListener;

    @Override
    protected void onOverScrolled(int scrollX, int scrollY,
                                  boolean clampedX, boolean clampedY) {
        if (scrollY == 0 && lastY != 0) {
            if (flingOverflowListener != null) {
                flingOverflowListener.onFling(mScroller.getCurrVelocity());
            }
        }
        lastY = scrollY;
    ...
    public void setFlingOverflowListener(OnFlingOverflowListener listener){
        flingOverflowListener = listener;
    }

    public interface OnFlingOverflowListener{
